"""
Django settings for QTipStore project.
...
SECRET_KEY = 'django-insecure-+!q#k1uz7b-ptgal37ymn*6i_u^j3j^hoj32oedr#jh%qia3wo'
...
WSGI_APPLICATION = 'QTipStore.wsgi.application'
